        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg sm:text-xl text-neutral-600 dark:text-neutral-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Where ethical investment meets blockchain innovation. Participate in Shariah-compliant business financing or invest in vetted halal cryptocurrency opportunities—all built on blockchain technology for complete transparency and immutability.
            </p>
          ...
          <div id="features" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
                Choose your path: invest for returns or create lasting social impact
              </p>
            </div>
