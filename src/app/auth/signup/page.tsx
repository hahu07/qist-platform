...
import { signIn, signUp, initSatellite } from "@junobuild/core";
...
function SignUpPageContent() {
  ...
  const handlePasskey = async () => {
    try {
      setLoading(true);
      setError("");
      // First try to sign up with passkey
      ...
      if (err?.message?.includes("already")) {
        try {
          ...
          console.error("Passkey sign-in error:", signInErr);
          setError("Failed to sign in with Passkey. Please try again.");
        }
      } else {
        console.error("Passkey sign-up error:", err);
        setError("Failed to sign up with Passkey. Please try again.");
      }
    } finally {
      setLoading(false);
    }
      ...
      <main className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  Most secure and private option. No email or personal data required. Your identity is cryptographically secured on the Internet Computer blockchain.
                </p>
              </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  Login with your fingerprint or face. Uses your device's biometric authentication for quick and secure access without passwords.
                </p>
              </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  Quick setup using your existing Google account. Convenient if you prefer familiar login methods.
                </p>
              </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-neutral-600 dark:text-neutral-400">
            ...
            <Link href="/auth/signin" className="font-semibold text-primary-600 dark:text-primary-400 hover:underline">
              Sign In
            </Link>
          </p>
        </div>
    ...
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-white via-neutral-50 to-white dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-600 dark:text-neutral-400">Loading sign up...</p>
        </div>
      </div>
    }>
      <SignUpPageContent />
