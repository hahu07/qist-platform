...
const baseInvestorFields = {
  memberNumber: z.string().optional(), // Auto-generated sequential membership number (e.g., "INV-2025-0001")
  ...
  // Admin feedback and rejection fields
  adminMessage: z.string().optional(),
  rejectionReason: z.string().optional(),
  rejectionAllowsResubmit: z.boolean().optional(), // If false, KYC cannot be resubmitted
