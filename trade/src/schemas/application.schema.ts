...
export const applicationDataSchema = z.object({
  ...
  // Contract Terms Review (Admin workflow)
  contractTermsStatus: z.enum(["pending", "approved", "counter-offered", "revision-requested"]).optional(),
  contractTermsCounterOffer: z.any().optional(), // Admin's alternative contract terms
  contractTermsRevisionMessage: z.string().optional(), // Admin's message requesting revision
  finalContractTerms: z.any().optional(), // Locked contract terms after mutual agreement
