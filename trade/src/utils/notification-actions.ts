...
export async function notifyKYCApproved(
  ...
  return createNotification(userId, {
    ...
    message: `Congratulations ${memberName}! Your identity verification has been approved. Your membership number is ${memberNumber}. You can now start investing in Shariah-compliant opportunities.`,
    priority: "high",
...
export async function notifyKYCRejected(
  ...
  return createNotification(userId, {
    ...
    message: allowsResubmit
      ? `${memberName}, your KYC verification requires additional information. Reason: ${reason}. Please review and resubmit your documents.`
      : `${memberName}, your KYC verification has been rejected. Reason: ${reason}. Please contact support for assistance.`,
    priority: "high",
    actionUrl: allowsResubmit ? "/member/kyc" : "/member/dashboard",
    metadata: {
...
export async function notifyKYCUnderReview(
  userId: string,
  memberName: string
) {
  return createNotification(userId, {
    ...
    message: `${memberName}, your KYC documents are now under review. We'll notify you once the verification is complete. This usually takes 1-3 business days.`,
    priority: "normal",
    actionUrl: "/member/dashboard",
    metadata: {
