              ...
              <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6">
                ...
                <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-blue-900 dark:text-blue-200 text-sm font-medium mb-1">Profile Settings</p>
                      <p className="text-blue-700 dark:text-blue-300 text-xs">
                        You can update your contact details and address. Identity information (name, nationality, ID) cannot be changed for security and compliance reasons. Contact support if you need to update identity information.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <form onSubmit={handleSaveProfile} className="space-y-6">
                  ...
                  {investorProfile?.memberNumber && (
                    <div className="p-4 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-primary-900 dark:text-primary-100 text-sm font-medium">Member Number</p>
                          <p className="text-primary-700 dark:text-primary-300 text-lg font-bold">{investorProfile.memberNumber}</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg">
                      {investorProfile?.investorType === 'individual' ? (
                        <>
                          <div>
                            <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-1">Full Name</p>
                            <p className="font-medium text-neutral-900 dark:text-white">{investorProfile.fullName}</p>
                          </div>
                          {investorProfile.nationality && (
                            <div>
                              <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-1">Nationality</p>
                              <p className="font-medium text-neutral-900 dark:text-white">{investorProfile.nationality}</p>
                            </div>
                          )}
                          {investorProfile.idType && (
                            <div>
                              <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-1">ID Type</p>
                              <p className="font-medium text-neutral-900 dark:text-white capitalize">{investorProfile.idType.replace('-', ' ')}</p>
                            </div>
                          )}
                          {investorProfile.idNumber && (
                            <div>
                              <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-1">ID Number</p>
                              <p className="font-medium text-neutral-900 dark:text-white">{investorProfile.idNumber}</p>
                            </div>
                          )}
                        </>
                      ) : (
                        <>
                          <div>
                            <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-1">Company Name</p>
                            <p className="font-medium text-neutral-900 dark:text-white">{investorProfile?.companyName}</p>
                          </div>
                          {investorProfile?.registrationNumber && (
                            <div>
                              <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-1">Registration Number</p>
                              <p className="font-medium text-neutral-900 dark:text-white">{investorProfile.registrationNumber}</p>
                            </div>
                          )}
                          {investorProfile?.legalEntityType && (
                            <div>
                              <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-1">Entity Type</p>
                              <p className="font-medium text-neutral-900 dark:text-white capitalize">{investorProfile.legalEntityType.replace('-', ' ')}</p>
                            </div>
                          )}
                          {investorProfile?.registrationCountry && (
                            <div>
                              <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-1">Registration Country</p>
                              <p className="font-medium text-neutral-900 dark:text-white">{investorProfile.registrationCountry}</p>
                            </div>
                          )}
                        </>
                      )}
                    ...
                    <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-2 flex items-center gap-1">
                      ...
                      These fields are locked for regulatory compliance and cannot be changed
                    </p>
                  </div>
