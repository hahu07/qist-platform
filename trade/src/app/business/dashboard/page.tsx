...
import { ContractTermsStatus } from "@/components/business/contract-terms-status";
import { getUnreadMessageCount } from "@/utils/platform-message-actions";
...
export default function BusinessDashboardV2() {
  ...
  const loadUnreadMessages = async () => {
    if (!user) return;
    try {
      const count = await getUnreadMessageCount(user.key);
      setUnreadMessages(count);
    } catch (error) {
      logger.error("Error loading unread messages:", error);
    }
  };
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-2xl border-2 border-neutral-200 dark:border-neutral-800 p-6">
            ...
            {!application ? (
              ...
              <div className="space-y-5">
                ...
                <ContractTermsStatus application={application} />
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-2xl border-2 border-neutral-200 dark:border-neutral-800 p-6 lg:col-span-2">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <Link
                ...
                className="flex items-center gap-3 p-4 border-2 border-neutral-200 dark:border-neutral-800 rounded-xl hover:border-primary-300 dark:hover:border-primary-700 hover:bg-primary-50/50 dark:hover:bg-primary-900/10 transition-colors relative"
              >
                ...
                {unreadMessages > 0 && (
                  <div className="absolute -top-1 -right-1 bg-red-600 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center shadow-lg">
              ...
              <Link
                href="/business/onboarding/profile?edit=true"
                className="flex items-center gap-3 p-4 border-2 border-neutral-200 dark:border-neutral-800 rounded-xl hover:border-primary-300 dark:hover:border-primary-700 hover:bg-primary-50/50 dark:hover:bg-primary-900/10 transition-colors"
              >
                <div className="w-10 h-10 bg-primary-100 dark:bg-primary-900/30 rounded-lg flex items-center justify-center">
                  <svg className="w-5 h-5 text-primary-600 dark:text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
