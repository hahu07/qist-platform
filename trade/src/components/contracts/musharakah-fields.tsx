        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-2">
              💡 Describe the joint venture's business activities and objectives
            </p>
            <textarea
              id="businessPurpose"
          ...
          <div className="p-4 bg-white dark:bg-neutral-800 rounded-lg border-2 border-neutral-200 dark:border-neutral-700">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-2">
                  💡 Amount the institution will invest in the partnership
                </p>
                <input
                  id="party1Capital"
                  type="number"
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-2">
                  💡 Proposed profit percentage for institution (can differ from capital ratio)
                </p>
                <input
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-2">
                  💡 Loss percentage (must match capital ratio per Islamic law)
                </p>
                <input
                  id="party1LossShare"
                  type="number"
          ...
          <div className="p-4 bg-white dark:bg-neutral-800 rounded-lg border-2 border-neutral-200 dark:border-neutral-700">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-2">
                  💡 Amount your business will contribute to the partnership
                </p>
                <input
                  id="party2Capital"
                  type="number"
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-2">
                  💡 Your proposed profit percentage (can differ from capital ratio)
                </p>
                <input
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-2">
                  💡 Your loss percentage (must match your capital ratio per Islamic law)
                </p>
                <input
                  id="party2LossShare"
                  type="number"
          ...
          <div>
            ...
            <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-2">
              💡 How partners can exit the partnership (buyout, IPO, liquidation, etc.)
            </p>
            <textarea
              id="exitStrategy"
